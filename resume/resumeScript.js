...
window.addEventListener("load", () => {
    ...
    let resumeDesignation = document.getElementById("resumeDesignation");
    ...
    let resumePass1 = document.getElementById("resumePass1");
    ...
    let resumePass2 = document.getElementById("resumePass2");
    ...
    let resumeSkill6 = document.getElementById("resumeSkill6");
    ...
    let resumeLang3 = document.getElementById("resumeLang3");
    resumeLang3.textContent = lang3;
    let resumeStartyear = document.getElementById("resumeStartyear");
    resumeStartyear.textContent = styear;
    let resumeEndyear = document.getElementById("resumeEndyear");
    resumeEndyear.textContent = endyear;
    let resumeCompany = document.getElementById("resumeCompany");
    resumeCompany.textContent = company;
    let resumeCompanylocation = document.getElementById("resumeCompanylocation");
    ...
    let resumeAchive1 = document.getElementById("resumeAchive1");
    resumeAchive1.textContent = achive1;
    let resumeAchive2 = document.getElementById("resumeAchive2");
    resumeAchive2.textContent = achive2;
    let resumeAchive3 = document.getElementById("resumeAchive3");
